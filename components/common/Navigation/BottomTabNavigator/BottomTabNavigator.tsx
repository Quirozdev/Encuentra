...
const BottomTabNavigator = () => {
  ...
  return (
    <Tab.Navigator screenOptions={({route}) => ({
      tabBarIcon: ({focused}) => <BottomTabIcon isFocused={focused} route={route.name}  />,
      tabBarLabel:() => {return null},
    })} tabBar={(props) => <CustomBottomTab state={props.state} descriptors={props.descriptors} navigation={props.navigation} insets={props.insets} />}>
